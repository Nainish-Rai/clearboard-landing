...
const features = [
  {
    ...
    description:
      "Automate, organize, and track tasks with smart AI assistance.",
    icon: Cloud,
    image:
      "https://cdn.dribbble.com/userupload/42259211/file/original-353db129ac5186ee038c346fddf90838.jpg?resize=1504x1128&vertical=center",
  },
  {
    id: "feature-2",
    title: "Real-Time Collaboration",
    description:
      "Work together instantly. Assign, comment, and update in real time.",
    icon: Star,
    image:
  ...
  },
  {
    ...
    description: "Get actionable analytics and suggestions for your workflow.",
    icon: Bolt,
    image:
      "https://cdn.dribbble.com/userupload/42259211/file/original-353db129ac5186ee038c346fddf90838.jpg?resize=1504x1128&vertical=center",
  },
  {
    ...
    description: "See all your projects, tasks, and progress in one place.",
    icon: MessagesSquare,
    image:
      "https://cdn.dribbble.com/userupload/15241853/file/original-4d2dc6d60a8e5e035ce52f5de0bb9d8a.png?resize=1504x1128&vertical=center",
  },
    ...
    <section className="py-12 md:py-24 lg:py-32">
      <div className="container mx-auto px-4">
        <div className="mb-8 text-center md:mb-12">
          ...
          <h2 className="">Meet Clearboard</h2>
          <p className="text-muted-foreground mx-auto mt-3 max-w-2xl text-sm md:mt-4 md:text-base">
            The AI dashboard to manage, automate, and track your tasks.
          </p>
        </div>
        <div>
                    ...
                    >
                      <div className="flex w-full items-start gap-3 md:gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          <h2
                            className={`mb-1 text-sm font-medium transition-colors md:text-base lg:text-lg ${
                              isSelected
                                ? "text-foreground"
